...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const strSum = `${a} and ${b} and ${c} sum to ${sumABC}.`;
    const strProduct = `The product of ${a} and ${b} and ${c} is ${multABC}.`;
    return [sumABC, multABC, strSum, strProduct];
...
export function sumArrayWithThreeNumbers(sumArr) {
    const sum = sumAndMultiplyThreeNumbers(sumArr[0], sumArr[1], sumArr[2])[0];  
    const str = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sum} is their sum.`;
    return [sum, str];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const mult = sumAndMultiplyThreeNumbers(multArr[0], multArr[1], multArr[2])[1];
    const str = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of 24.`;
    return [mult, str];
}
